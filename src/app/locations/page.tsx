export const metadata = {
  title: 'Locations — Elegant Boutique MW',
  description: 'Find Elegant Boutique shops in Blantyre and Lilongwe, Malawi.',
};
    ...
    <div className="bg-cream min-h-screen">
      ...
      <div className="bg-cream-dark py-12 text-center">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <h1 className="font-serif text-4xl sm:text-5xl text-ink">Our Locations</h1>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-cream-card border border-ink/10 p-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="font-serif text-2xl text-ink">Blantyre</h3>
            </div>
            <div className="space-y-3 text-sm text-ink-muted">
              <p className="font-medium text-ink">Pacific Mall, Shop A5 (Downstairs)</p>
              <p>Behind Immigration Office</p>
              <p>Independence Drive, Blantyre</p>
              <div className="pt-3 border-t border-ink/10">
                <p className="font-medium text-ink mb-1">Hours</p>
                <p>Monday – Saturday: 8:00 AM – 5:00 PM</p>
              </div>
              <div className="pt-3">
                <a href="tel:+265997544522" className="text-gold hover:text-gold-dark transition-colors font-medium">
                  +265 997 544 522
                </a>
              </div>
              <div className="pt-3">
                <a
                  href="https://www.google.com/maps/search/?api=1&query=Pacific+Mall+Blantyre+Malawi"
                  target="_blank"
          ...
          <div className="bg-cream-card border border-ink/10 p-8">
            ...
            <div className="space-y-3 text-sm text-ink-muted">
              <p className="font-medium text-ink">Old Gulliver Market</p>
              ...
              <div className="pt-3">
                <a href="tel:+265888522590" className="text-gold hover:text-gold-dark transition-colors font-medium">
                  +265 888 522 590
                </a>
              </div>
              <div className="pt-3">
                <a
                  href="https://www.google.com/maps/search/?api=1&query=Old+Gulliver+Market+Area+49+Lilongwe+Malawi"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1 text-gold hover:text-gold-dark transition-colors text-sm font-medium"
                >
